...
related_transition_id: "transition-task-17-3-1-done"
...
approval_statement: "I approve controlled complete-active lifecycle mutation for task task-17-3-1 using transition transition-task-17-3-1-done."
