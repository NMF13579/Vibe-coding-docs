...
active_task_snapshot:
  ...
  source_task: "tests/fixtures/negative/execution-runner/shared/source-task.md"
  source_contract: "tests/fixtures/negative/execution-runner/session-missing-source-contract-scope/missing-source-contract.md"
