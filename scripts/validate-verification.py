...
DEFAULT_TARGET = ROOT / "reports" / "verification.md"
SCHEMA_PATH = ROOT / "schemas" / "verification.schema.json"
...
def main():
    ...
    try:
      ...
      print("PASS: verification validation passed")
      return 0
    except Exception as exc:
      print("FAIL: verification validation failed")
      print(str(exc))
      return 1
