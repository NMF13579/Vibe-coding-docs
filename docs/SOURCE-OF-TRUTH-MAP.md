...
|---|---|---|
| `reports/milestone-22-markdown-to-script-inventory.md` | FOUND | Использован как вход M22 и база рисков |
| `docs/MARKDOWN-ROLE-CLASSIFICATION.md` | NOT_FOUND | Файл отсутствует |
