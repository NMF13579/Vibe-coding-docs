...
|------|-----|-------------|
| `docs/AGENT-BOOTSTRAP.md` | instruction | При старте новой сессии или потере контекста — **читать первым** |
| `docs/CONTEXT-LOSS-RECOVERY.md` | instruction | При симптомах потери контекста агентом |
| `docs/ANTI-PATTERNS.md` | instruction | При сомнении в выборе подхода — чего не делать |
| `docs/DECISION-GUIDE.md` | instruction | При архитектурных развилках — что выбрать и почему |
| `docs/EXPLAINER-GLOSSARY.md` | instruction | При непонимании терминов проекта |
| `docs/STACK-PRESETS.md` | instruction | При выборе технологического стека |
| `docs/PM-DIALOG-STYLE.md` | instruction | При ведении диалога с владельцем проекта |
| `docs/TASK-TEMPLATE.md` | template | При создании задач |
| `docs/TASK-REVIEW-PROTOCOL.md` | instruction | При проверке выполненных задач перед закрытием |
| `docs/TESTING-GUIDE.md` | instruction | При написании тестов и проверке после задачи |
| `docs/VALIDATION.md` | instruction | При написании правил валидации |
| `docs/ERROR-TYPES.md` | instruction | При классификации ошибок: тип → действие |
| `docs/ROLLBACK-PROTOCOL.md` | instruction | При откате релиза («всё сломалось») |
| `docs/RELEASE-CHECKLIST.md` | instruction | Перед каждым релизом |
| `docs/SECURITY_POLICY.md` | instruction | При работе с персональными данными и доступами |
| `docs/ROADMAP.md` | project-record | После принятия MVP-решений — дорожная карта |
| `docs/AUDIT-GUIDE.md` | instruction | При проведении аудита проекта |
| `docs/AUDIT-CHECKLIST.md` | instruction | Расширенный чеклист качества и готовности |
| `docs/adapters/` | instruction | При работе в Cursor / Copilot / Claude / Gemini — IDE-специфичный self-check |
...
|------|--------|-----|----------|
| `memory-bank/interview-session.md` | 1 (черновик) | project-record | Пошаговый журнал интервью до переноса в discovery |
...
| `processes/PROCESSES.md` | 1 | project-record | Как устроена работа шаг за шагом |
| `processes/ROLES.md` | 1 | project-record | Кто участвует и за что отвечает |
...
| `docs/AGENTS.md` | 2 | instruction | Карта ролей агентов и правила многоагентной работы |
| `docs/ENV.md` | 2 | project-record | Описание переменных окружения и правила хранения секретов |
| `docs/MONITORING.md` | 2 | instruction | Базовый мониторинг после релиза и сигналы для отката |
| `docs/AUDIT-CHECKLIST.md` | 2 | instruction | Расширенный чеклист проверки качества и готовности |
| `docs/USER-FLOWS.md` | 2 | instruction | Ключевые пользовательские сценарии для smoke-теста |
...
| `docs/POST-LAUNCH-REVIEW.md` | 2 | project-record | Разбор после запуска и фактов использования |
| `docs/ORPHAN-FILES-REPORT.md` | 2 | project-record | Отчёт о файлах без ссылок в навигации |
| `docs/AGENT-BOOTSTRAP.md` | 0 | instruction | Диагностика и старт агента — читать первым |
| `docs/CONTEXT-LOSS-RECOVERY.md` | 0 | instruction | Восстановление после потери контекста |
| `docs/ANTI-PATTERNS.md` | 0 | instruction | Чего не делать при выборе решений |
| `docs/DECISION-GUIDE.md` | 0 | instruction | Справочник развилок: что выбрать и почему |
| `docs/EXPLAINER-GLOSSARY.md` | 0 | instruction | Словарь терминов простым языком |
| `docs/STACK-PRESETS.md` | 0 | instruction | Готовые наборы инструментов по типу проекта |
| `docs/PM-DIALOG-STYLE.md` | 0 | instruction | Стиль диалога с владельцем |
| `docs/TASK-TEMPLATE.md` | 0 | template | Шаблон задачи |
| `docs/TASK-REVIEW-PROTOCOL.md` | 0 | instruction | Протокол проверки перед закрытием задачи |
| `docs/TESTING-GUIDE.md` | 0 | instruction | Чеклист проверки после каждой задачи |
| `docs/VALIDATION.md` | 0 | instruction | Объективная проверка: работает / не работает |
| `docs/ERROR-TYPES.md` | 0 | instruction | Классификация ошибок: тип → действие |
| `docs/ROLLBACK-PROTOCOL.md` | 0 | instruction | Инструкция при «всё сломалось» / «откати» |
| `docs/RELEASE-CHECKLIST.md` | 0 | instruction | Чеклист перед каждым релизом |
| `docs/SECURITY_POLICY.md` | 0 | instruction | Безопасность и работа с чувствительными данными |
| `docs/ROADMAP.md` | 0 | project-record | Дорожная карта после принятия MVP-решений |
| `docs/AUDIT-GUIDE.md` | 0 | instruction | Руководство по проведению аудита |
| `docs/adapters/` | 0 | instruction | IDE-специфичный self-check для Cursor / Copilot / Claude / Gemini |
