...
> Updated: 2026-04-18 (agent-rules bootstrap v2)
...
2026-04-18 — **agent-rules:** в начало [`agent-rules.md`](../LAYER-1/agent-rules.md) добавлены BOOTSTRAP PROTOCOL, STATE AUTHORITY и HANDOFF PROTOCOL (STATE.md, guards, handoff). См. [`HANDOFF.md`](../HANDOFF.md).
