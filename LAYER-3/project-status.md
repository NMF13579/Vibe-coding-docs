...
2026-04-18 — **ARCHITECTURE:** в корневой [`ARCHITECTURE.md`](../ARCHITECTURE.md) добавлен раздел **State Control Plane** (state layer, компоненты, домены, поток сессии). См. [`HANDOFF.md`](../HANDOFF.md).
