...
| **Фокус** | State-first шаги из `# BOOTSTRAP PROTOCOL` в начале этого файла; при необходимости — `context-recovery.md` | Модули пайплайна, scope-guard, приоритет `shared/priority-order.md` |
...
> размещение альтернативных версий bootstrap/protocol рядом с канонической.
> Если появляется второй вариант — он немедленно переносится в
> `LAYER-1/deprecated/`.
