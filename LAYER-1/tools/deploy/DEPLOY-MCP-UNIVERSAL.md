...
> Кладётся в репозиторий как `LAYER-1/tools/deploy/DEPLOY-MCP-UNIVERSAL.md`.
...
- Перед деплоем проверяй `LAYER-1/tools/deploy/DEPLOY-CHECKLIST.md`.
- После деплоя фиксируй результат в `LAYER-1/tools/deploy/RELEASE-NOTES.md`.
- Post-launch review — в `LAYER-2/qa/post-launch-review.md`.
- Если что-то пошло не так — записывай в `LAYER-1/tools/deploy/RUNBOOK.md`.
```
