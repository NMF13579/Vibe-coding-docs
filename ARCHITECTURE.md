...
| LAYER-3/STATE.md | Единственный formal control plane: Project + Session + Task, guards | Нарратив, история сессий вместо канона |
| LAYER-1/agent-rules.md | State-first bootstrap protocol + State authority | Правила агента |
| HANDOFF.md | Контракт сессии (что сделано, следующий шаг; reference snapshot) | Канон формального state, полная история сессий |
